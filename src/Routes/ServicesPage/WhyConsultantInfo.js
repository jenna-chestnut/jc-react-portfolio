...
class ConsultantWhys extends React.Component {
	render() {
		return (
			<div>
				...
				<article className="bottomspace">
					...
					<p>
						...
						you’re so bogged down by the day to day. You’re stretched as thin as
						possible.
					</p>
					<p>
						So you keep pushing things off, turning opportunities down, saying
						“no” when you want to say “yes” - and saying “yes” when you want to
						say “no”.
					</p>
					<p>
						<b>
						...
						(You know that it’s totally possible because you’ve seen other small
						businesses do the same!){' '}
					</p>
					<p>
						But your expertise is in the vision, and the thought of learning and
						organizing and building systems, and writing SOPs, and hiring an
						assistant, and… you get it. It’s a lot of small details, and you’re
						on a mission to change lives.{' '}
					</p>
					<p>
						<b>
							You need someone detail oriented, organized and strategic to help
							structure/optimize what you already have in place - and help
							implement what you're envisioning for the future of your company.
						</b>
					</p>
				</article>
				<article className="topspace bottomspace">
					...
					<p>
						<b>
							You need someone with an outside perspective that can breathe new
							life into your business, and offer new insight on what may be
							missing (or unecessary) when it comes to your goals.
						</b>
					</p>
				</article>
				<article className="bottomspace">
					...
					<p>
						...
						you're getting pretty tired of having to do everything by yourself.
					</p>
					<p>
						...
						systemetizing your operations - so you can enjoy some time off while
				...
				<article className="bottomspace">
					...
					<p>
						Simply put, you don't want to do a particular project (like creating
						a sales funnel or setting up automations) and would like to
						outsource it. Clear communication is a non-negotiable!
					</p>
					<p>
						<b>
