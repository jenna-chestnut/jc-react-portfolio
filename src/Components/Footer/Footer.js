        ...
        <footer>
          <hr className='footer-bar'></hr>
            ...
            <div className='item group footer-contact'>
                <span>Jenna Chestnut / <a href='https://linktr.ee/jenna.chestnut' target='_blank' rel='noopener noreferrer'><b>@Jenna</b></a>
                </span>
                ...
                <a href='https://instagram.com/RestructSure' target="_blank" rel="noreferrer"><img src={instagramIcon} alt='tiny twitter icon'/></a>
